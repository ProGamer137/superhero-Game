...
function setup() {
  ...
  box4 = new Box(650,280,50,50)
  box5 = new Box(600,260,50,50)
  box6 = new Box(650,280,50,50)
  box7 = new Box(600,260,50,50)
  box8 = new Box(650,220,50,50)
  box9 = new Box(600,220,50,50)
  box10 = new Box(650,220,50,50)
